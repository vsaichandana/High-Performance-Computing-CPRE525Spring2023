...
#define print_matrix_diag(mat) print_matrix_diagonal(mat,#mat); // NEWLY ADDED FOR LAB14 ASSIGNMENT
...
void print_matrix_diagonal(const matrix* mat, char* name); // NEWLY ADDED FOR LAB14 ASSIGNMENT
