...
#define print_trimatrix_diag(t) print_trimatrix_diagonal(t,#t) // NEWLY ADDED FOR LAB14 ASSIGNMENT
...
void print_trimatrix_diagonal(const trimatrix* trimat, char* varname); // NEWLY ADDED FOR LAB14 ASSIGNMENT
